...
urlpatterns = [
    ...
    path('acharge fixe/<int:pk>/detail',DetailChargeFixeView.as_view(), name="detail_charg_fix"),
    ...
    path('charge variable/<int:pk>/detail',DetailChargeVarView.as_view(), name="detail_charg_var"),
