...
urlpatterns = [
    ...
    path('notifications/<int:pk>/', NotificationsPageView.as_view(), name='notification_detail'),
    ...
    #-------------------------------------------Categorie Véhicule--------------------------------------------- 
    path('Ajouter-categorie-vehicule', AddCategoriVehi.as_view(), name='add_catego_vehi'),
    ...
    path('categorie/<int:pk>/delete', delete_catego, name='delete_catego'),
    ...
    path('vehicules/<int:pk>/excel-import/exemplaire', DownloadVehiculeExcelTemplateView.as_view(), name='download_vehicule_excel_template'),
    ...
    path('piece-echange/export-excel/', ExportPiecEchangeExcelView.as_view(), name='export_piec_echange_excel'),
    path('piece/export-excel/', ExportPieceExcelView.as_view(), name='export_piece_excel'),
    ...
    path('export-assurance-excel/', ExportAssuranceExcelView.as_view(), name='export_assurance_excel'),
