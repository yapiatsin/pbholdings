    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_recherche', models.CharField(choices=[('Cours..', 'Cours..'), ('Retrouver', 'Retrouver'), ('Egarer', 'Egarer')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_sortie', models.DateTimeField()),
                ('motif', models.CharField(choices=[('1', 'Visite'), ('2', 'Panne'), ('3', 'Accident')], max_length=20)),
